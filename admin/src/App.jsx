  ...
  useEffect(() => {
    ...
    const syncFCMToken = async () => {
      try {
        ...
        // Reuse existing registration if possible
        ...
        if (fcmToken) {
          await axios.post(
            `${backendUrl}/api/admin/save-token`,
            { token: fcmToken },
            {
              headers: {
          ...
          <main className="pt-16 lg:pl-64 min-h-screen">
            <div className="p-4 md:p-6">
              <Routes>
                ...
                <Route
                  path="/view/:id"
                  element={<ViewProduct token={token} />}
                />
                ...
                <Route
                  path="/subcategories"
                  element={<Subcategories token={token} />}
                />
                ...
                <Route
                  path="/fields"
                  element={<FieldManagement token={token} />}
                />
                ...
                <Route
                  ...
                  element={<AddSubscription token={token} />}
                />
                <Route
